...
|파트|진행상태|학습시간|강의내용|비고|
| ------ | ------ | ------ | ------ | ------ |
| | | 0 | [강의 개요](컴퓨터-구조) | 권장 학습기간: `8주`, 학습분량: 주당 `5시간`|
|1| :white_check_mark: |1| [컴퓨터-구조 개요](컴퓨터-구조/컴퓨터-구조-개요.md) | |
|1| :white_check_mark: |1| [1장 디지털 논리 회로 및 강의소개](컴퓨터-구조/1장-디지털-논리-회로-및-강의소개.md) | |
...
|2| :black_large_square: |3| [9장 파이프라인과 벡터 처리](컴퓨터-구조/9장-파이프라인과-벡터-처리.md) | 생략 |
|2| :black_large_square: |3| [10장 컴퓨터 산술 연산](컴퓨터-구조/10장-컴퓨터-산술-연산.md) | 생략 |
...
|1| :white_check_mark: |1| [1장 네트워크](네트워크/1장-네트워크.md) | |
|| :white_large_square: |1| [2장 네트워크 모델](네트워크/2장-네트워크 모델.md) | |
